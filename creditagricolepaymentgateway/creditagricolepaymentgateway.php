...
class CreditAgricolePaymentGateway extends PaymentModule
{
    ...
    public function createRatepayScript($paymentMethod)
    {
        ...
        try {
            echo $this->context->smarty->fetch(_PS_MODULE_DIR_ . 'creditagricolepaymentgateway' . DIRECTORY_SEPARATOR .
    ...
    public function hookActionFrontControllerSetMedia()
    {
        ...
        foreach ($this->getPayments() as $paymentMethod) {
            if ($paymentMethod->getLoadJs()) {
                ...
                $ajaxSepaUrl = $link->getModuleLink('creditagricolepaymentgateway', 'sepadirectdebit');
                Media::addJsDef(
                    array(
